...
public class UnGamepadState
{
	static Dictionary<int,float> outputMax = new Dictionary<int,float> ()
	{
        ...
        {(int)UnGamepadConfig.InputTarget.Action5,1},
        {(int)UnGamepadConfig.InputTarget.Action6,1},
        {(int)UnGamepadConfig.InputTarget.Home,1}
    };
	static Dictionary<int,float> outputMin = new Dictionary<int,float> ()
	{
        ...
        {(int)UnGamepadConfig.InputTarget.Action5,0},
        {(int)UnGamepadConfig.InputTarget.Action6,0},
        {(int)UnGamepadConfig.InputTarget.Home,0}
    };
	...
	public bool GetButton (GamepadButton buttonType)
	{
        ...
        case GamepadButton.Action5:
            return GetInputBool(UnGamepadConfig.InputTarget.Action5);
        case GamepadButton.Action6:
            return GetInputBool(UnGamepadConfig.InputTarget.Action6);
        case GamepadButton.Home:
            return GetInputBool(UnGamepadConfig.InputTarget.Home);
        }
